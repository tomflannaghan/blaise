...
def test_encrypt_with_positive_shift():
    ...
    plaintext = "HELLO"
    result = caesar_encrypt(plaintext, key=1)
    assert result == "IFMMP"
...
def test_encrypt_with_zero_shift():
    ...
    plaintext = "HELLO"
    result = caesar_encrypt(plaintext, key=0)
    assert result == "HELLO"
...
def test_encrypt_with_wraparound():
    ...
    plaintext = "XYZ"
    result = caesar_encrypt(plaintext, key=3)
    assert result == "ABC"
...
def test_encrypt_with_full_rotation():
    ...
    plaintext = "HELLO"
    result = caesar_encrypt(plaintext, key=26)
    assert result == "HELLO"
...
def test_encrypt_with_key_greater_than_26():
    ...
    plaintext = "HELLO"
    result_27 = caesar_encrypt(plaintext, key=27)
    result_1 = caesar_encrypt(plaintext, key=1)
    assert result_27 == result_1


def test_encrypt_empty_string():
    """Encrypting empty string should return empty string."""
    result = caesar_encrypt("", key=5)
    assert result == ""
...
def test_decrypt_with_positive_key():
    ...
    ciphertext = "IFMMP"
    result = caesar_decrypt(ciphertext, key=1)
    assert result == "HELLO"
...
def test_decrypt_with_zero_key():
    ...
    ciphertext = "HELLO"
    result = caesar_decrypt(ciphertext, key=0)
    assert result == "HELLO"
...
def test_decrypt_with_wraparound():
    ...
    ciphertext = "ABC"
    result = caesar_decrypt(ciphertext, key=3)
    assert result == "XYZ"


def test_decrypt_empty_string():
    """Decrypting empty string should return empty string."""
    result = caesar_decrypt("", key=5)
    assert result == ""
...
def test_encrypt_decrypt_roundtrip():
    ...
    plaintext = "HELLO"
    key = 7
    ciphertext = caesar_encrypt(plaintext, key=key)
    decrypted = caesar_decrypt(ciphertext, key=key)
...
def test_roundtrip_with_single_character():
    ...
    for char in "ABCDEFGHIJKLMNOPQRSTUVWXYZ":
        key = 13
        ciphertext = caesar_encrypt(char, key=key)
        decrypted = caesar_decrypt(ciphertext, key=key)
...
def test_crack():
    plaintext = "THEQUICKBROWNFOXJUMPSOVERTHELAZYDOG"
    ciphertext = caesar_encrypt(plaintext, 23)
