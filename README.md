...
See https://github.com/tomflannaghan/blaise/actions/workflows/documentation.yml
...
- Functions should be prefixed with the cipher name. `XXX_encrypt` and `XXX_decrypt` should both exist for all ciphers.
